...
public class FoodFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        foodRecycler = (RecyclerView)view.findViewById(R.id.people_recyclerview_fragment);
        ...
        foodRecycler.setAdapter(cardViewAdapter);
        ...
        audioPlayer = new AudioPlayer(foodRecycler);
    ...
    public void onResume() {
        super.onResume();
        CardViewAdapter cardViewAdapter = (CardViewAdapter)foodRecycler.getAdapter();
