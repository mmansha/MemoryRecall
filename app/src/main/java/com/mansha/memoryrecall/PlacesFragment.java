...
public class PlacesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        placesRecycler = (RecyclerView)view.findViewById(R.id.people_recyclerview_fragment);
        ...
        placesRecycler.setAdapter(cardViewAdapter);
        ...
        audioPlayer = new AudioPlayer(placesRecycler);
    ...
    public void onResume() {
        super.onResume();
        CardViewAdapter cardViewAdapter = (CardViewAdapter) placesRecycler.getAdapter();
